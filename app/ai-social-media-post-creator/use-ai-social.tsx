...
export default function UseAISocialMedia() {
  const industries = [
    {
      id: 1,
      ...
      <div className="max-w-[70rem] mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-[32px] font-bold text-[#F2F2F2] mb-6 leading-[48px] text-center">
            Use AI Social Media Post Generator?
          </h2>
          <p className="text-[18px] font-normal text-white/90  max-w-2xl mx-auto leading-[28px] text-center">
            Our AI Social Media Post Generator is designed for anyone who wants
            to save time, improve creativity, and boost engagement on platforms
            like Instagram, Facebook, LinkedIn, and Twitter (X).
          </p>
        </div>
