  ...
  const benefits = [
    {
      ...
      description:
        "Make pro product images, social posts, and personal photos in minutes with Marqait AI—built for business and everyday use.",
    },
    {
      title: "Save Time and Effort",
      description:
        "Let AI handle the editing while you focus on creativity. No complex tools, no extra steps – just fast, polished results.",
    },
    {
      title: "Works Anywhere",
      description:
        "Edit photos online from desktop or mobile, anytime you want. No downloads or heavy software required – just upload and start editing.",
    },
  ];
            ...
            {benefits.map((benefit, index) => (
              <div
                ...
                className={`bg-gradient-to-b from-[rgba(9,9,9,0.3)] to-[rgba(184,18,255,0.15)] backdrop-blur-[10px] border-0 border-r border-b border-l border-t rounded-lg p-6 hover:border-purple-400/80 transition-colors duration-300 flex flex-col justify-between ${
                  index === 1
                    ? "border-[#B812FF] h-[160px]"
                    : index === 0 || index === 2
                      ? "border-[#B812FF] h-[150px]"
                      : "border-[#B812FF] h-[140px]"
                }`}
              >
