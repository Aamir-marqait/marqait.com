        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[80vh]">
          ...
          <div className="space-y-8 sm:space-y-12 lg:space-y-16">
            ...
            <div className="space-y-2 sm:space-y-5 lg:-mt-24 relative">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl font-bold leading-none relative z-10">
                <span
                  style={{
                    background:
...
export default function AIBlog() {
  useSEO({
    ...
    description: "Marqait AI Blog keeps you up-to-date about the latest advancements in our AI marketing automation tools and platform.",
    canonical: "https://www.marqait.com/ai-blog",
    keywords: "AI blog, artificial intelligence, marketing automation, AI insights, AI tools, technology updates",
    ogType: "website",
