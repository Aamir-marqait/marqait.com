  ...
  const benefits = [
    {
      ...
      description:
        "AI automates repetitive tasks like emails, reporting, SEO audits, and data entry.",
      position: "left",
    },
    {
      title: "Reduce Costs with Lean Teams",
      description:
        "Hiring big teams is costly. AI lets you handle marketing, sales, and analytics with minimal manpower.",
      position: "left",
    },
    {
      title: "Smarter Decision-Making",
      description:
        "AI provides predictive analytics and actionable insights—helping startups make better decisions faster.",
      position: "left",
    },
    {
      title: "Enhance Customer Experience",
      description:
        "AI chatbots, personalization engines, and recommendation systems create customer experiences on par with big brands.",
      position: "right",
    },
    {
      title: "Scale Faster",
      description:
        "With automation, startups can handle 10x more workload without adding proportional costs.",
      position: "right",
    },
    {
