...
interface AISolutionPageClientProps {
  solution: any;
}

export default function AISolutionPageClient({ solution }: AISolutionPageClientProps) {
              ...
              <div className={`grid lg:grid-cols-2 gap-12 lg:gap-16 items-center ${
                ...
                <div className={`space-y-8 ${section.sectionType === 'imageLeft' ? 'lg:order-2' : ''}`}>
                  <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
                    {section.heading?.normalText && (
                      <span>{section.heading.normalText} </span>
                    )}
          ...
          <section key={index} className="py-20 px-4 bg-[#05000A]">
            <div className="container mx-auto max-w-7xl">
              ...
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                {/* Process Illustration - Only render if image exists */}
          ...
          <section key={index} className="py-20 px-4 bg-[#05000A] relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-7xl relative z-10">
              ...
              <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 items-center">
                ...
                {/* Center Column - Image - Only render if image exists */}
          ...
          <section key={index} className="py-20 px-4 bg-gradient-to-br from-[#05000A] via-purple-900/20 to-[#05000A] relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-7xl relative z-10">
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                {/* Right Column - Image - Only render if image exists */}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a0b2e] via-[#16213e] to-[#0f051a] w-full overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6 lg:space-y-8">
              <h1 className="text-2xl md:text-3xl lg:text-5xl font-bold text-white leading-tight">
                {solution.heroSection?.mainHeading?.line1 && (
                  <span className="block">{solution.heroSection.mainHeading.line1}</span>
                )}
                {solution.heroSection?.mainHeading?.line2 && (
                  <span className="block mt-1">{solution.heroSection.mainHeading.line2}</span>
                )}
              </h1>
              ...
              {solution.heroSection?.ctaButton && (
                <div className="pt-2">
                  <Link
                    href={solution.heroSection.ctaButton.link || '/consultation'}
                  ...
                  >
                    {solution.heroSection.ctaButton.text || 'Book a Free Consultation'}
                  </Link>
                </div>
              )}
            </div>

            {/* Right Column - Hero Image - Only render if image exists */}
            {solution.heroSection?.heroImage?.asset && (
              <div className="relative flex justify-center lg:justify-end">
                <div className="relative max-w-md lg:max-w-lg">
                  <Image
                    src={urlFor(solution.heroSection.heroImage).width(1000).height(1000).url()}
      ...
      {solution.contentSections?.map((section: any, index: number) => 
