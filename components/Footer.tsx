...
export default function Footer() {
  ...
  const footerLinks: {
    ...
    truintel: [
      { text: "AI Visibility Audit", url: "https://truintel.ai/" },
      { text: "AI Search Monitoring", url: "https://truintel.ai/ai-search-monitoring" },
      { text: "ChatGPT Visibility Tracker", url: "https://truintel.ai/chatgpt-visibility-tracker" },
      { text: "Gemini Visibility Tracker", url: "https://truintel.ai/gemini-visibility-tracker" },
      { text: "Perplexity Visibility Tracker", url: "https://truintel.ai/perplexity-visibility-tracker" },
      { text: "Claude Visibility Tracker", url: "https://truintel.ai/claude-visibility-tracker" },
      { text: "AI Overview Tracker", url: "https://truintel.ai/ai-overview-tracker" },
      { text: "Competitor Analysis Tool", url: "https://truintel.ai/competitor-analysis-tool" },
      { text: "Free SEO Audit", url: "https://truintel.ai/free-seo-audit" },
      { text: "TruIntel AI CMS", url: "https://truintel.ai/ai-cms" },
      { text: "Pricing", url: "https://truintel.ai/pricing" },
      { text: "Get Started Free", url: "https://app.truintel.ai/register" },
    ],
    aiTools: [
