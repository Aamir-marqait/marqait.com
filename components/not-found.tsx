        ...
        <div className="text-center space-y-8 sm:space-y-12 lg:space-y-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 lg:gap-8 pt-8 sm:pt-12">
            <button
              ...
              className="flex items-center gap-3 px-6 sm:px-8 lg:px-10 py-3 sm:py-4 lg:py-5 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-semibold rounded-full transition-all duration-200 text-sm sm:text-base lg:text-lg w-full sm:w-auto sm:min-w-[200px] justify-center"
            >
            ...
            <button
              ...
              className="flex items-center gap-3 px-6 sm:px-8 lg:px-10 py-3 sm:py-4 lg:py-5 border border-gray-600 hover:border-gray-500 text-white font-semibold rounded-full transition-all duration-200 text-sm sm:text-base lg:text-lg w-full sm:w-auto sm:min-w-[200px] justify-center"
            >
