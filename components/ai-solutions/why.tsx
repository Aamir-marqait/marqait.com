    ...
    <div className=" w-screen mx-auto h-screen">
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-center">
        ...
        <div className="lg:col-span-3 space-y-8">
          <div>
            <h2 className="font-inter font-bold text-[40px] leading-[150%] text-white/90 mb-6">
              Why Your Business Needs One?
            </h2>
            <p className="font-inter max-w-2xl font-normal text-[24px] leading-[150%] text-white/90">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={index} className="flex items-start gap-4 max-w-3xl">
                ...
                <div>
                  ...
                  <span className="font-inter font-normal text-[16px] leading-[150%] text-white/90">
                    {" "}{benefit.description}
                  </span>
                </div>
              </div>
